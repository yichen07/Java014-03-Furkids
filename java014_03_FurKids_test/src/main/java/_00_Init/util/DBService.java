...
public class DBService {
	...
	private static final String DBURL_SQLServer = "jdbc:sqlserver://" + host + ":1433;databaseName=furkids";
	public  static final String USERID_SQLServer = "sa";
	public  static final String PSWD_SQLServer = "sa123456";

	public  static final String nameMs = "java:comp/env/jdbc/Furkids";
	public  static final String nameMy = "java:comp/env/jdbc/Furkids";
	...
	private static final String DBURL_MySQL = "jdbc:mysql://" + host
			+ "/furkids?useUnicode=yes&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Taipei&allowPublicKeyRetrieval=true";
	public static final String USERID_MySQL = "root";
	public static final String PSWD_MySQL = "12345";
