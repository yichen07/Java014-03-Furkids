			...
			<div class="col-md-12 text-center">
				...
				<div
					...
					<h2 class="text-center">
						<i class="fas fa-address-card"></i>&nbsp;會員基本資料
					</h2>
				</div>
				<div
					class="align-items-center banner-text animate__animated animate__fadeInUp">
			...
			<div class="col-lg-12">
				<div class="card rightContent outerlayer" style="height: auto;">
					<div class="container-fluid bgtype_opacity">
						...
						<!-- 會員基本資料清單 -->
						<div
							class="row justify-content-start ml-5 animate__animated animate__fadeInLeft">
									...
									<fieldset class="m-3 innerlayer">
										...
										<div class="form-group has-feedback text-center">
											...
											<form:input path="memberMultipartFile" type="file"
												id="image_file" style="display: none;" disabled="true" />
										</div>

										<div class="form-group has-feedback border-top">
											<label class="mt-3"><b>帳號 / 電子信箱</b></label>
											<form:input path="cusAccount" class="form-control"
										...
										<div class="form-group has-feedback">
											<label><b>性別</b></label>
											<form:input path='cusGender' class="form-control" type="text"
												disabled="true" />
										</div>
										...
										<div class="form-group has-feedback">
											...
											<form:input path="cusBirthday" class="form-control"
												type="date" value="${LoginOK.cusBirthday}" disabled="true" />
										</div>
