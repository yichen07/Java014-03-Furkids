		...
		<div class="collapse navbar-collapse justify-content-between animate__animated animate__fadeInDown"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown mx-2">
					<a class="nav-link nav-font" href="<c:url value='/_03_listProducts/DisplayPageProducts2' />" 
					...
					<c:when test="${LoginOK.CLASSIFY == 0}">
						<div class="dropdown nav-item">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item"
									href="<c:url value='/_05_orderProcess/orderList' />" >訂單查詢</a>
							</div>
						</div>
					</c:when>
					<%-- 商家(已登入) --%>
...
<!-- 				</a> -->
				<a href="<c:url value='/_04_ShoppingCart/ShowCartContent' />" class="m-2">
					<i class="fas fa-shopping-cart navbar-cart fa-lg"></i>
				</a>
