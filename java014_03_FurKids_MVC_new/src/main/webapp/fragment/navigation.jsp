...
<%-- Navbar --%>
<nav
	class="navbar navbar-light navbar-expand-lg bg-white sticky-top shadow"
	id="navBar" style="z-index: 9999">
	<div class="container">

		<%-- Logo --%>
		<a class="navbar-brand mb-1" href="<c:url value='/' />"><img
			src="<c:url value='/resources/images/Logo_07.png' />" alt="Logo"
			height="26" /></a>
		...
		<%-- 功能導覽列 --%>
		<div
			class="collapse navbar-collapse justify-content-between animate__animated animate__fadeInDown"
			...
			<ul class="navbar-nav">
				<%-- 商城 --%>
				<li class="nav-item dropdown mx-2"><a class="nav-link nav-font"
					href="<c:url value='/_03_listProducts/DisplayPageProducts2' />"
					id="navbarDropdownMenuLink" role="button" aria-haspopup="true"
					aria-expanded="false"> <i class="fas fa-store-alt"
						style="color: grey"></i>&nbsp;寵物商城
				</a> <%-- 					<a class="nav-link nav-font" href="<c:url value='#' />"  --%>
...
<%-- 							href="<c:url value='/_03_listProducts/DisplayPageProducts2' />">購物商城</a> --%>
<!-- 					</div></li> -->
				<%-- 寵物交流版 --%>
				<li class="nav-item dropdown mx-2"><a class="nav-link nav-font"
					href="<c:url value='http://127.0.0.1:8081/' />"
					id="navbarDropdownMenuLink" role="button" aria-haspopup="true"
					aria-expanded="false"> <i class="fas fa-handshake"
						style="color: grey"></i>&nbsp;寵物交流版
				</a> <%-- 					<a class="nav-link nav-font" href="<c:url value='#' />" --%>
					<!-- 						id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> -->
				...
				<%-- 寵物友善系統 --%>
				<li class="nav-item dropdown mx-2"><a class="nav-link nav-font"
					href="<c:url value='#' />" id="navbarDropdownMenuLink"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <i class="fas fa-hand-holding-heart"
						style="color: grey"></i>&nbsp;寵物友善系統
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						<a class="dropdown-item"
							href="<c:url value='/_03_FriendlySystem/Reservation/景點' />">景點</a>
						<a class="dropdown-item"
				...
				<%-- 寵物健康管理 --%>
				<li class="nav-item dropdown ml-2 mr-5"><a
					class="nav-link nav-font" href="<c:url value='#' />"
					id="navbarDropdownMenuLink" role="button" data-toggle="dropdown"
					aria-haspopup="true" aria-expanded="false"> <i
						class="fas fa-user-md" style="color: grey"></i>&nbsp;寵物健康管理
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
						<a class="dropdown-item" href="<c:url value='#' />">熱量管理</a> <a
							class="dropdown-item" href="<c:url value='/BlogIndex' />">寵物健康專欄</a>
			...
			<div class="form-inline my-2 my-lg-0">
				<c:choose>
					...
					<c:when test="${empty LoginOK}">
						<a href="<c:url value='#' />" class="ml-4 m-2" data-toggle="modal"
							data-target="#login"> <i
							class="fas fa-user navbar-user fa-lg"></i>
						</a>
					</c:when>
					<%-- 會員(已登入) --%>
					<c:when test="${LoginOK.CLASSIFY == 0}">
						<div class="dropdown nav-item">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item"
									href="<c:url value='/PetRegistration' />">寵物新增</a> <a
									class="dropdown-item"
									href="<c:url value='/MemberManagementCenter' />">會員管理</a> <a
									class="dropdown-item"
					...
					<c:when test="${LoginOK.CLASSIFY == 1}">
						<div class="dropdown nav-item">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item"
									href="<c:url value='/MerchantChildRegistration' />">分店新增</a> <a
									class="dropdown-item"
									href="<c:url value='/MerchantManagementCenter' />">商家管理</a> <a
									class="dropdown-item"
				...
				<a href="<c:url value='/_04_ShoppingCart/ShowCartContent' />"
					class="m-2"> <i class="fas fa-shopping-cart navbar-cart fa-lg"></i>
				</a>
										...
										<div class="memberCardData">
											<div class="memberCardContent">
												...
												<a href="<c:url value='/MemberRegistration' />"
													class="memberCardButton pt-1">立刻加入</a>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="modal-body">
				<div class="text-center">
					<font color="red">${InsertOK} ${FlashMSG_farewell}
						${sessionScope.timeOut} ${UpdateOK} ${UpdateError}</font>
				</div>
			</div>
			<div class="modal-footer">
