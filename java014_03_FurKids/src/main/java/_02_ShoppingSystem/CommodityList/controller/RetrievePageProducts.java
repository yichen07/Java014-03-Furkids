...
@WebServlet("/_02_ShoppingSystem/DisplayPageProducts")
...
//		// 書籍資料等。
		...
		Map<Integer, CommodityBean> CommodityMap = service.getPageCommodity(pageNo);
		session.setAttribute("pageNo", String.valueOf(pageNo));
		request.setAttribute("totalPages", service.getTotalPages());
		// 將讀到的一頁資料放入request物件內，成為它的屬性物件
		session.setAttribute("products_DPP", CommodityMap);
