	...
	<section class="imgBackground">
		<div class="container-fluid">
			<div class="row wrapperOut">
				<!-- Left Content Start ---------------------->
				<div
					class="col-xl-7 col-lg-8 col-md-10 col-12 mt-5 wrapper my-md-5 my-0 ml-md-5 ml-0 mb-5 pb-5 mt-lg-5">
					<form class="mt-0">
						<div class="px-1">
							<div class="row">
							...
							<div
								...
								<div class="col-9 pr-5">
									<div class="input-group">
										<input type="password" required="required" id="eyeInput" />
