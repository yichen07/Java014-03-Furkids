...
<!--        <FORM  action='BuyBook.do' method="POST">   -->
   ...
   <TR height='32' bgColor="${rowColor}">
       <TD width='560'>
         <TABLE border='1'>
            <TR height='31'>
               <TD width='420'>廠商：${entry.value.busName}</TD>
               <TD width='140'>庫存：${entry.value.comStock}</TD>
            </TR>
         </TABLE>
      </TD>
   </TR>
   <TR height='32' bgColor="${rowColor}">
       <TD width='560'>
           <TABLE border='1'> 
              <TR height='31'>
                 <TD width='160'>商品號：${entry.value.comId}</TD>                 
                 <TD width='140'>訂價：<fmt:formatNumber value="${entry.value.comPrice}"  pattern="####" />元</TD>
