		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					style="font-size: 24px; padding: 8px;" href="#" id="navbarDropdown"
				...
				<li class="nav-item dropdown"><a class="nav-link text_size"
					style="font-size: 24px; padding: 8px;" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
			...
			<ul class="navbar-nav my-2 my-lg-0">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<c:if test="${LoginOK.CLASSIFY == 1}">
								<a class="dropdown-item"
									href="<c:url value='/_03_ConvenienceProcess/Convenience_H.do' />">商家管理</a>
							</c:if>
						</div></li>
				</c:if>
				<li class="nav-item"><c:choose>
						<c:when test="${empty LoginOK}">
							<a class="nav-link" href="#" data-toggle="modal"
								data-target="#login"> <p1
									style="font-size: 24px; padding: 8px;">會員登入</p1> <p2> <img
									src="${pageContext.request.contextPath}/resources/images/member.svg"
									width="40px" height="auto" alt="" /> </p2>
							</a>
						</c:when>
						<c:when test="${LoginOK.CLASSIFY == 0}">
							<a class="nav-link" href="#"> <p1
									style="font-size: 24px; padding: 8px;">會員中心</p1> <p2> <img
									src="${pageContext.request.contextPath}/_00_init/getHeadshot?account=${LoginOK.cusAccount}"
									width="40px" height="auto" alt="" /> </p2>
							</a>
						</c:when>
						<c:when test="${LoginOK.CLASSIFY == 1}">
							<a class="nav-link" href="#"> <p1
									style="font-size: 24px; padding: 8px;">商家中心</p1> <p2> <img
									src="${pageContext.request.contextPath}/_00_init/getHeadshot?account=${LoginOK.busAccount}"
									width="40px" height="auto" alt="" /> </p2>
							</a>
						</c:when>
				...
				<li class="nav-item"><a class="nav-link" href="#"><p1
							style="font-size: 24px; padding: 8px;">購物車</p1> <p2> <img
							src="${pageContext.request.contextPath}/resources/images/cart.svg"
							width="40px" height="auto" alt="" /> </p2> </a></li>

				<li class="nav-item"><c:if test="${ ! empty LoginOK }">
						<a class="nav-link"
							href="<c:url value='/_01_Member/logout.jsp' />"><p1
								style="font-size: 24px; padding: 8px;">登出</p1> <p2> <img
								src="${pageContext.request.contextPath}/resources/images/logout_2.png"
								width="40px" height="auto" alt="" /> </p2> </a>
					</c:if></li>
			</ul>
...
>>>>>>> 3793f47ac13af774fe9466734e65a5b9667b2f38
...
=======
						<label for="exampleInputEmail1">帳號</label> <input type="text"
							class="form-control" name="userId" id="exampleInputEmail1"
							aria-describedby="emailHelp" placeholder="Enter email"
							value="${requestScope.user}${param.userId}"> <small
							class="form-text text-muted"><font color="red">${ErrorMsgKey.AccountEmptyError}</font></small>
>>>>>>> 3793f47ac13af774fe9466734e65a5b9667b2f38
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">密碼</label> <input
							...
							value="${requestScope.password}${param.pswd}"> <small
							class="form-text text-muted"><font color="red">${ErrorMsgKey.PasswordEmptyError}</font></small>
					</div>
...
=======
						<p class="font-small white-text d-flex justify-content-center">
							尚未創建帳號 <a href="#" class="green-text ml-1 font-weight-bold">立即註冊</a>
						</p>
					</div>
>>>>>>> 3793f47ac13af774fe9466734e65a5b9667b2f38
				</form>
